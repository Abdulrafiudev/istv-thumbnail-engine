...
function AssetPanel({ asset, label }) {
  return (
    <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
      <div style={{ background: '#000', flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
        <img
      ...
      <div style={{ padding: '12px 16px', borderTop: `1px solid ${BRAND.border}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12 }}>
    ...
    >
      ...
      >
        ...
        <div style={{ padding: '14px 20px', borderBottom: `1px solid ${BRAND.border}`, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ color: BRAND.text, fontFamily: BRAND.font, fontSize: 14, fontWeight: 600 }}>
            Compare
          </span>
