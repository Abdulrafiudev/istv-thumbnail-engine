...
// Default style presets for Inside Success TV thumbnail generation.
//
// Each promptTemplate contains ONLY style-specific sections:
//   [BACKGROUND] / [SOURCE PHOTO INTEGRATION] / [LIGHTING] / [ATMOSPHERE]
//
// The universal sections — [SUBJECT CONSTRAINTS], [COMPOSITION], [STYLE],
// [TEXT CONSTRAINT] — are prepended/appended by prompt-builder.js, so they stay
// DRY and consistent across every preset and every variation.
//
// The token {{INDUSTRY}} is substituted at runtime from the free-text industry field.
